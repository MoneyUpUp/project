...
me_delete_swagger = swagger_auto_schema(
    ...
    responses={
        200: openapi.Response("삭제 성공"),
        401: "인증 실패",
    },
    tags=["accounts"],
)

login_post_swagger = swagger_auto_schema(
    operation_summary="로그인 (POST)",
    operation_description="이메일과 비밀번호를 입력해 로그인하며, 성공 시 사용자 정보와 토큰을 반환합니다.",
